<template>
  <v-row>
    ...
    <!-- Breakpoint mdAndUp -->
    <v-col v-if="$vuetify.breakpoint.mdAndUp" sm="12">
      <v-card flat>
        <v-card-title width="85%" class="px-16 mx-12 font-weight-bold headline">
          My Centers
        </v-card-title>
      </v-card>
      <v-container>
          ...
          <v-row>
            <v-col cols="5" lg="6">
              <v-list-item three-line>
                ...
                <v-list-item-content>
                  <v-list-item-title class="headline font-weight-bold mb-1 text-wrap" :class="$vuetify.breakpoint.md ? 'title':''">
                    {{ center.name }}
                  </v-list-item-title>
                  <v-list-item-subtitle v-if="!$vuetify.breakpoint.md" class="subtitle text-wrap">
            ...
            <v-col cols="7" lg="6" class="colstyle">
              <v-card-text class="my-10">
                <v-card-subtitle class="subtitle-1 py-0">
                  <v-row>
                    <v-col cols="6" offset="1" class="py-2">
                      <v-icon class="warning--text">
                        mdi-clock
                      </v-icon>
                      Bookings to manage:
